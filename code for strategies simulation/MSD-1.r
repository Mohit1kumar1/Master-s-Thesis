...
st.restrict.marker.data   ( ExHet.MIN = 0.05, data.set ="PP" )  


gs.esteff.rr ( method="BLUP", data.set="PP")  
yld.eff <- gs.return.effects (data.set="PP" ) 

gs.write.pseff( yld.eff, file="data/effect.file.eff")    
...
eval <- c("PP","Psel","SYN1","SYN2","SYN2sel","SYN3","SYN3sel","DH")
...
########################################################################
# write.table (e,"data/c002-123-e001.dta")  #   200 reps
  write.table (e,"data/c002-123-e002.dta")  #   1000 reps